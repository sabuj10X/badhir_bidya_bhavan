      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 w-full py-12">
        ...
        <div className="text-center mb-10 max-w-4xl">
          <p className="text-indigo-800 text-lg md:text-xl font-medium leading-relaxed">
            Dedicated to empowering the deaf and hearing-impaired community through education, 
            skill development, and creating an inclusive society where everyone can thrive.
          </p>
        </div>
