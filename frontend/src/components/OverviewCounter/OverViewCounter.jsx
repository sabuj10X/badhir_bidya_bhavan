...
const OverViewCounter = () => {
  return (
    ...
    >
      <div className="mx-auto my-4 grid w-full grid-cols-4 divide-x text-gray-600 divide-slate-700 bg-white p-2 shadow-lg dark:bg-gray-800 dark:divide-slate-300 dark:text-white/70 md:max-w-[800px] lg:-translate-y-20 md:p-8 rounded-lg">
        ...
        <div className="flex flex-col items-center justify-center">
         ...
         <div className="flex flex-col items-center justify-center">
          ...
          <p className="sm:text-md text-xs md:text-lg">Doneters</p>
        </div>
        <div className="flex flex-col items-center justify-center">
          <p className="text-sm font-bold text-black/80 dark:text-white sm:text-lg md:text-3xl">
            <CountUp
